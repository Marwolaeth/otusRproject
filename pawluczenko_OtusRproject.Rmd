...
**Не удалось**, к сожалению, в полной мере реализовать перспективный при таких данных, как наши, метод [fused lasso](https://pdfs.semanticscholar.org/f73f/ca3a80099dc649c81d9a59c995c315eaab6a.pdf)(pdf!), реализованный в библиотеке [smurf](https://cran.r-project.org/web/packages/smurf/vignettes/smurf.html).
...
Получившиеся коэффициенты свидетельствуют, что извлеченные из текстовых переменных признаки внесли вклад в регрессию:
